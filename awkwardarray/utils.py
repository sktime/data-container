...
def awkward_detabularize(x: np.ndarray, content_counts: np.ndarray, counts: np.ndarray) -> JaggedArray:
    """Detabularises a 2-D Numpy array generated by awkward_tabularize().

    Parameters
    ----------
    x : np.ndarray
        The Numpy array generated by awkward_tabularize().

    content_counts : np.ndarray
        The array of counts for the content array for the JaggedArray to return.

    counts : np.ndarray
        The array of counts for the JaggedArray to return.
